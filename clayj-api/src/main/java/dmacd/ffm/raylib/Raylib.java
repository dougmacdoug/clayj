...
public class Raylib {
    ...
    public static class Model {
        ...
        private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
            ...
            RayFFM.C_INT.withName("meshCount"),
            RayFFM.C_INT.withName("materialCount"),
            RayFFM.C_POINTER.withName("meshes"),
            RayFFM.C_POINTER.withName("materials"),
            RayFFM.C_POINTER.withName("meshMaterial"),
            RayFFM.C_INT.withName("boneCount"),
            MemoryLayout.paddingLayout(4),
            RayFFM.C_POINTER.withName("bones"),
            RayFFM.C_POINTER.withName("bindPose")
        ).withName("Model");
        ...
        private static final ValueLayout.OfInt meshCount$LAYOUT = (ValueLayout.OfInt)$LAYOUT.select(groupElement("meshCount"));
        ...
        private static final ValueLayout.OfInt materialCount$LAYOUT = (ValueLayout.OfInt)$LAYOUT.select(groupElement("materialCount"));
        ...
        private static final ValueLayout.OfInt boneCount$LAYOUT = (ValueLayout.OfInt)$LAYOUT.select(groupElement("boneCount"));
