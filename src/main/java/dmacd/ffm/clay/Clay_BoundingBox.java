...
public class Clay_BoundingBox {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ClayFFM.C_FLOAT.withName("x"),
        ClayFFM.C_FLOAT.withName("y"),
        ClayFFM.C_FLOAT.withName("width"),
        ClayFFM.C_FLOAT.withName("height")
    ).withName("Clay_BoundingBox");
