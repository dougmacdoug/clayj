...
public class Clay_BorderWidth {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ClayFFM.C_SHORT.withName("left"),
        ClayFFM.C_SHORT.withName("right"),
        ClayFFM.C_SHORT.withName("top"),
        ClayFFM.C_SHORT.withName("bottom"),
        ClayFFM.C_SHORT.withName("betweenChildren")
    ).withName("Clay_BorderWidth");
    ...
    private static final OfShort betweenChildren$LAYOUT = (OfShort)$LAYOUT.select(groupElement("betweenChildren"));
     ...
     * }
     */
    public static final OfShort betweenChildren$layout() {
        return betweenChildren$LAYOUT;
    }

    private static final long betweenChildren$OFFSET = 8;
     ...
     * }
     */
    public static final long betweenChildren$offset() {
        return betweenChildren$OFFSET;
    }
     ...
     * }
     */
    public static short betweenChildren(MemorySegment struct) {
        return struct.get(betweenChildren$LAYOUT, betweenChildren$OFFSET);
    }
     ...
     * }
     */
    public static void betweenChildren(MemorySegment struct, short fieldValue) {
        struct.set(betweenChildren$LAYOUT, betweenChildren$OFFSET, fieldValue);
    }
